...
const Index = () => {
  ...
  useEffect(() => {
    document.title = "صوت البلد — صوتك واصل | أخبار مصر العاجلة";
  }, []);
  ...
  const homeDesc = "صوت البلد - صوتك واصل. أخبار مصر العاجلة، تقارير سياسية ورياضية واقتصادية، نتائج الإعدادية وأسعار العملات والذهب لحظة بلحظة.";

  return (
    <div className="min-h-screen bg-background text-right antialiased relative" dir="rtl">
      <Helmet>
        <title>صوت البلد — صوتك واصل | أخبار مصر العاجلة</title>
        <meta name="description" content={homeDesc} />
        <link rel="canonical" href={`${SITE_URL}/`} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="صوت البلد — صوتك واصل | أخبار مصر العاجلة" />
        ...
        <meta name="twitter:title" content="صوت البلد — صوتك واصل" />
