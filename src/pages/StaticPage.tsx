...
export const AboutPage = () => (
  <StaticPage slug="about" title="من نحن" description="منصة مصدري الإخباري — تعرّف على هويتنا وقيادتنا ورسالتنا.">
    <p><strong>منصة مصدري الإخباري</strong> هو الاسم الرسمي الذي يصلك من قلب الحدث، نقدّم لك الخبر المصري بصدق وسرعة ودقة، ونرافقك على مدار الساعة في السياسة والاقتصاد والرياضة والتكنولوجيا وكل ما يهم الشارع المصري.</p>
    <h2>قيادتنا</h2>
    ...
    <h2>رسالتنا</h2>
    <p>«منصة مصدري الإخباري» — شعار نلتزم به: نسمع منك، ننقل عنك، ونوصل صوتك للمسؤول وللرأي العام.</p>
    <h2>قِيَمنا</h2>
    <ul>
