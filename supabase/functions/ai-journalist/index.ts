...
serve(async (req) => {
 ...
 {
 role: "system",
 content: `أنت "صائد الأخبار" داخل "مصدري للأخبار المصرية والعالمية". أعد إنتاج الخبر بالكامل بأسلوب صحفي احترافي موسّع، بحيث يفهمه القارئ دون الرجوع لأي مصدر خارجي.
