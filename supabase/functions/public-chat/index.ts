...
const SYSTEM_PROMPT = `أنت «بوت صوت البلد» — المساعد الرسمي الذكي لـ "مصدري للأخبار المصرية والعالمية".
...
- للحجز الإعلاني والتواصل المباشر: برئاسة وتطوير: البشمبرمج/ خالد عاطف عبدالحكيم — واتساب: +20 100 618 8795.
...
async function buildLocalReply(query: string) {
  ...
  if (isContactQuery(q)) {
    return `## التواصل مع صوت البلد\n\n- **رئيس المؤسسة:** برئاسة وتطوير: البشمبرمج/ خالد عاطف عبدالحكيم\n- **واتساب الحجوزات والإعلانات:** [+20 100 618 8795]()\n\nيسعدنا تواصلكم في أي وقت.`;
  }
  if (isAboutQuery(q)) {
    return `أنا **بوت صوت البلد** — المساعد الرسمي لمؤسسة "مصدري للأخبار المصرية والعالمية"، بقيادة **برئاسة وتطوير: البشمبرمج/ خالد عاطف عبدالحكيم** وتطوير **التقني/ خالد عاطف عبدالحكيم عويس**.`;
  }
  if (isResultQuery(q)) {
